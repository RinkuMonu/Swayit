        ...
        <div class="swayitbusiness">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="createCustomPackage88">
                        <p class="createCustomPackagee88">Fast and Easy Varying Forms Of Payment From Businesses To
                            You</p>
                    </div>
                    ...
                    <div class="howmuch">
                        ...
                        <div class="arrows">
                            <a href="{{ route('influencer.seven') }}"><i class="fa fa-arrow-left arrowBg" aria-hidden="true"></i></a>
                ...
                <div class="col-md-6">
                    <div class="right-col">
                        <img src="{{ asset('asset/image/influencer88.png') }}" class="sideimg88" alt="" />
                        <img src="{{ asset('asset/image/screenShort5.gif') }}" class="screenShort8" alt="" />
                        <img src="{{ asset('asset/image/boyImage8.png') }}" class="boyImage8" alt="" />
