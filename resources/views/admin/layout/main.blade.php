...
<head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="{{ asset('admin/images/swayiticon.png') }}?v={{ time() }}" />
    <style>
        .modal-content {
        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
                <a class="navbar-brand brand-logo" href="index.html"><img
                        src="{{ asset('admin/images/swayitlogo.png') }}" alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="index.html"><img
                        src="{{ asset('admin/images/swayiticon.png') }}" alt="logo" />
                </a>
            </div>
            ...
            <div class="main-panel">
                ...
                <footer class="footer">
                    <div class="text-center">
                        <span class="text-muted text-center text-sm-center d-block d-sm-inline-block">COPYRIGHT © 2024
                            SWAY IT All
