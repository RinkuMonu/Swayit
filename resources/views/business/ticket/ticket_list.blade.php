                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex ticketlistborder">
                                            @if ($list->status == 1)
                                                ...
                                                <form id="close-ticket-form{{ $list->id }}" action="{{ route('business.close.ticket') }}" method="POST" style="display: none;">
                                                    @csrf
                                                    <input type="hidden" name="id" value="{{ $list->id }}">
                                                </form>
                                            @endif
                                                &nbsp;
                                                <a href="{{ route('business.reply.ticket', $list->ticket_id) }}">
                                                ...
                                                <form id="delete-ticket-form{{ $list->id }}" action="{{ route('business.delete.ticket') }}" method="POST" style="display: none;">
                                                    @csrf
                                                    <input type="hidden" name="id" value="{{ $list->id }}">
                                                </form>
                                        </td>
