                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form theme-form">
                            <form class="row needs-validation" action="{{ route('business.store.campaign') }}" method="post"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <label>Campaign Name</label>
                                        <input class="form-control" type="text" placeholder="Enter campaign name" name="name">
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label for="delivery_time">Add Attachment</label>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="theme-form">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="objectives" id="text-box" cols="10" rows="2"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 mb-2">
                                                        <div class="single-influencer">
                                                            <a href="{{ route('business.view.profile', $list->id) }}" target="_blank">
                                                                @if ($list->profile_img)
                                                            ...
                                                            <div class="text-body">
                                                                <h6><a href="{{ route('business.view.profile', $list->id) }}" target="_blank">{{ $list->first_name }} {{ $list->last_name }}</a></h6>
                                                                <p>{!! \Illuminate\Support\Str::limit($list->bio, 30) !!}</p>
                                                            </div>
                                                            <div class="check-box">
                                                                <input type="checkbox" class="check-box-input" name="influencer_id[]" value="{{ $list->id }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    @endforeach
