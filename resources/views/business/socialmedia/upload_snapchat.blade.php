    ...
    <div class="container-fluid">
      <div class="page-title">
        <div class="row">
          ...
          <div class="col-6">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{ asset('business.dashboard') }}">                                       
                      ...
                      <div class="card-header p-4">
                          <div class="media">
                              <div class="media-user me-2">
                                  <div class="social-icons"><img src="{{ asset('assets/images/socialconnect/snapchetpost.png') }}" alt="facebook icon" style="width: 43px;"></div><span>Snapchat</span>
                              </div>
