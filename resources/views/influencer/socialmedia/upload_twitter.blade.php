    ...
    <div class="row">
      ...
      <div class="col-6">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Twitter Upload</li>
        </ol>
      </div>
    </div>
  </div>
      ...
      <div class="card-body add-post">
        <div class="row">
          <div class="col-sm-8 col-xl-8">
            <h4>Post Photo or Video to Twitter</h4>
            <div class="card-body">
              ...
              <div class="tab-content" id="icon-tabContent">
                ...
                <div class="tab-pane fade show active" id="image" role="tabpanel">
                  <form method= "POST" action="{{ route('influencer.uploadTo.twitter') }}" enctype="multipart/form-data" class="dropzone">
                    @csrf
                ...
                <div class="tab-pane fade" id="video" role="tabpanel">
                  <form class="dropzone" method="POST" action="{{ route('influencer.upload.twitter') }}" enctype="multipart/form-data">
                    @csrf
          ...
          <div class="col-sm-4 col-xl-4">
            <div class="main-content-body tab-pane p-4 border-top-0 active" id="twitter">
              <div class="card mg-b-20 border">
                <div class="card-header p-4">
                  <div class="media">
                    <div class="media-user me-2">
                      <div class="social-icons"><img src="{{ asset('assets/images/socialconnect/twitter.png') }}" alt="twitter icon" style="width: 43px;"></div><span>Twitter</span>
                    </div>
                ...
                <div class="card-body">
                  <p class="mg-t-0">Your Twitter post preview will appear here after submission.</p>
