...
@endphp
    ...
    <div class="connect-social-card">
        ...
        <div class="sub-social-sec">
    @if($connected && $connected->facebook_page_id && $connected->facebook_page_token)
    <a href="{{ route('influencer.upload.facebook') }}" class="btn btn-primary">Upload</a>

    {{-- Add Disconnect button when connected --}}
    <form action="{{ route('disconnect.facebook') }}" method="POST" style="display:inline;">
        @csrf
        <button type="submit" class="btn btn-danger">Disconnect</button>
    </form>
@else
    <a href="{{ route('redirect.facebook') }}" class="btn btn-primary">Connect</a>
@endif

            <button type="button" class="social-info-btn" data-bs-toggle="modal" data-bs-target="#facebookDetails">
     ...
     <div class="col-md-8 mx-auto">
        ...
        @php
  $connected = auth()->user()->instagram_account_id && auth()->user()->facebook_page_token;
@endphp
    <div class="connect-social-card">
        <div class="sub-social-sec">
        ...
        <div class="sub-social-sec">
   @if(auth()->user()->instagram_account_id)
    <a href="{{ route('influencer.upload.instagram') }}" class="btn btn-primary">Upload</a>
    <form action="{{ route('disconnect.instagram') }}" method="POST" style="display:inline;">
        @csrf
        <button type="submit" class="btn btn-danger">Disconnect</button>
    </form>
@else
    <a href="{{ route('instagram.connect') }}" class="btn btn-primary">Connect</a>
@endif
...
<div class="col-md-8 mx-auto">
  <div class="connect-social-card">
   ...
   <div class="sub-social-sec">
    @if(Auth::user()->youtube_token)
    <a href="{{ route('influencer.upload.youtube') }}" class="btn btn-primary">Upload</a>

    <form action="{{ route('youtube.disconnect') }}" method="POST" style="display:inline;">
        @csrf
        <button type="submit" class="btn btn-danger">Disconnect</button>
    </form>
@else
    <a href="{{ route('youtube.login') }}" class="btn btn-primary">Connect</a>
@endif
    <button type="button" class="social-info-btn" data-bs-toggle="modal" data-bs-target="#youtubeDetails">
        <i class="fa fa-info-circle"></i>
    </button>
</div>
        ...
        <div class="col-md-8 mx-auto">
            <div class="connect-social-card">
                ...
                <div class="sub-social-sec">
                    @if(Auth::user()->twitter_oauth_token)
                     <a href="{{ route('influencer.upload.twitter') }}" class="btn btn-primary">Upload</a>
    
                        <form action="{{ route('disconnect.twitter') }}" method="POST" style="display:inline;">
                            @csrf
                            <button type="submit" class="btn btn-danger">Disconnect</button>
                        </form>
                    @else
                        <a href="{{ route('twitter.connect') }}" class="btn btn-primary">Connect</a>
                    @endif
                        <button type="button" class="social-info-btn" data-bs-toggle="modal" data-bs-target="#youtubeDetails">
                            <i class="fa fa-info-circle"></i>
                        </button>
    ...
    @if(auth()->user()->tiktok_access_token)
        ...
        <a href="{{ route('influencer.upload.tiktok') }}" class="btn btn-primary">Upload</a>&nbsp;&nbsp;

        <form method="POST" action="{{ route('disconnect.tiktok') }}" style="display:inline;">
            @csrf
            <button type="submit" class="btn btn-danger">Disconnect</button>
        </form>
    @else
        <a href="{{ route('influencer.tiktok.login') }}" class="btn btn-primary">Connect</a>&nbsp;&nbsp;
    @endif

    <button type="button" class="social-info-btn" data-bs-toggle="modal" data-bs-target="#tiktokDetails">
        <i class="fa fa-info-circle"></i>
    </button>
</div>
 </div>
        ...
        <div class="col-md-8 mx-auto">
            <div class="connect-social-card">
                ...
                <div class="sub-social-sec">
                    ...
                    <a href="{{ route('influencer.upload.snapchat') }}" class="btn btn-primary">Upload</a>&nbsp;&nbsp;
        ...
        <div class="col-md-8 mx-auto">
            <div class="connect-social-card">
                ...
                <div class="sub-social-sec">
                    {{-- <a href="" class="btn btn-primary">Connect</a>&nbsp;&nbsp; --}}
                    <a href="{{ route('influencer.upload.bereal') }}" class="btn btn-primary">Upload</a>&nbsp;&nbsp;
        ...
        <div class="col-md-8 mx-auto">
            <div class="connect-social-card">
                ...
                <div class="sub-social-sec">
                    {{-- <a href="" class="btn btn-primary">Connect</a>&nbsp;&nbsp; --}}
                    <a href="{{ route('influencer.upload.twitch') }}" class="btn btn-primary">Upload</a>&nbsp;&nbsp;
...
<div class="modal fade" id="instagramConnect" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        ...
        <form action="{{ route('influencer.connectInstagram') }}" method="POST" enctype="multipart/form-data">
            @csrf
