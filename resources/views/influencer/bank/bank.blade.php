                        ...
                        <div class="row bank-list">
                            ...
                            @foreach ($bank_list as $list)
                                <div class="col-md-10 bank-details mb-2">
                                    ...
                                    <form action="{{ route('influencer.deleteBank') }}" method="POST" id="delete-bank-form{{ $list->id }}">
                                        @csrf
                        ...
                        <div class="row bank-list">
                            ...
                            @foreach ($paypal_list as $list)
                                <div class="col-md-10 bank-details mb-2">
                                    ...
                                    <form action="{{ route('influencer.deletePaypal') }}" method="POST" id="delete-paypal-form{{ $list->id }}">
                                        @csrf
                                        <input type="hidden" name="id" value="{{ $list->id }}">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <form action="{{ route('influencer.addPaypal') }}" method="post" enctype="multipart/form-data">
                        @csrf
    ...
    <div class="modal fade" id="addBank" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <form action="{{ route('influencer.addBank') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group mb-2">
