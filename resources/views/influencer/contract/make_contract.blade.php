...
<style>
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('influencer.update.contract') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card p-5">
                ...
                <div class="contract-description mt-3">
                    <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Shipping Address" id="shipping_address" name="shipping_address" value="{{ $contract->shipping_address }}" required>
                    </div>
                </div>

                <div class="contract-description mt-3">
                    <div class="form-group mb-2">
                        <input type="checkbox" class="form-check-input" id="contract_accept_checkbox" name="contract_accept_checkbox" value="1" required @if($contract->person_two_agree) checked @endif>&nbsp;
...
<div class="modal fade" id="uploadSignature" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('influencer.upload.signature') }}" method="POST" enctype="multipart/form-data" id="signatureForm">
                @csrf
