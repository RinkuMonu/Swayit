                            ...
                            <div class="col pe-0 chat-right-aside">
                                <div class="chat">
                                    <div class="chat-header clearfix">
                                        @if ($receiver)
                                            <img class="rounded-circle" src="{{ asset('storage/' . $receiver->profile_img) }}"
                                                alt="">
                                        @else
                                        ...
                                        @endif
                                        <div class="about">
                                            <div class="name">{{ $receiver->first_name }} {{ $receiver->last_name }}</div>
                                        </div>
                                    ...
                                    <form action="{{ route('influencer.send.bidmessage') }}" method="post">
                                        @csrf
