                                                        ...
                                                        @foreach ($user_messages as $messages)
                                                            ...
                                                            @if ($messages->sender_id == $current_user->id)
                                                                @if ($messages->attachment)
                                                                    <li class="clearfix">
                                                                        <a href="{{ asset('storage/' . $messages->attachment) }}" target="_blank">
                                                                        <div class="message my-message pull-right"
                                                                            ...
                                                                            <div style="color: #6e6e6e; font-size: 16px;"><i class="fa fa-paperclip" style="font-size: 26px;"></i>&nbsp; Attachment</div>
                                                                        </div>
                                                                    </a>
                                                                    </li>
                                                                @endif
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-12 d-flex">
                                                            ...
                                                            <div class="smiley-box bg-primary">
                                                                ...
                                                                <input type="file" name="chat_attachment" id="chat_attachment">
                                                            </div>
            ...
            $('[id^=chat-form-]').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#chat-form-' + userId + ' #chat_attachment').val(''); // Clear the file input
