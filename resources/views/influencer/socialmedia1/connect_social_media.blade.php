...
<div class="container-fluid">
    @php
        ...
        $facebookData = \App\Models\FacebookConnection::where('user_id', $currentUser->id)->first();
    @endphp
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="connect-social-card">
                ...
                <div class="sub-social-sec">
                    @if($facebookData)
                    <a href="{{ route('influencer.facebook.details') }}" class="btn btn-primary" target="_blank">Get Details</a>&nbsp;&nbsp;
                    @else
            ...
            <div class="connect-social-card">
                ...
                <div class="sub-social-sec">
                    @if($instagram_details)
                        <a href="{{ route('influencer.getInstagram') }}" class="btn btn-primary" target="_blank">View</a>
                    @else
            ...
            <div class="connect-social-card">
                ...
                <div class="sub-social-sec">
                    @if($googleUser)
                        ...
                        @else
                            <a href="{{ route('influencer.youtube.data') }}" class="btn btn-primary" target="_blank">Get Details</a>&nbsp;&nbsp;
                        @endif
                    @else
        ...
        <div class="col-md-8 mx-auto">
            <div class="connect-social-card">
                ...
                <div class="sub-social-sec">
                    <a href="{{ route('auth.twitter') }}" class="btn btn-primary">Connect</a>&nbsp;&nbsp;
