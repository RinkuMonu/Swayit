...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card p-4">
            <form action="{{ route('influencer.find.influencers') }}" method="GET">
                @csrf
                <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="social-details">
                                ...
                                <div class="d-flex" style="justify-content: center;">
                                    <h5 class="mb-1 f-22">{{ $list->first_name }} {{ $list->last_name }}</h5>&nbsp;&nbsp;&nbsp;
                                    @if($blue_tick >= 20)
                                ...
                                <h4 class="f-16 pt-2">{!! $list->bio !!}</h4><hr>
                                ...
                                <a href="{{ route('influencer.view.profile', $list->id) }}" class="btn btn-primary">View Profile</a>
