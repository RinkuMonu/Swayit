          ...
          <div class="row">
            ...
            <div class="col-6">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Do Do List</li>
              </ol>
            </div>
          </div>
        </div>
                  ...
                  <div class="card-body"> 
                    <div class="email-app-sidebar left-bookmark custom-scrollbar">
                      ...
                      <ul class="nav main-menu">
                        ...
                        <li class="nav-item"> <a href="javascript:void(0)"><span class="iconbg badge-light-primary"><i data-feather="file-plus"></i></span><span class="title ms-2">All Task</span><span class="badge badge-primary">{{ $all_task }}</span></a></li>
                        <li class="nav-item"><a href="javascript:void(0)"><span class="iconbg badge-light-success"><i data-feather="check-circle"></i></span><span class="title ms-2">Completed</span><span class="badge badge-success">{{ $completed }}</span></a></li>
                        <li class="nav-item"><a href="javascript:void(0)"><span class="iconbg badge-light-danger"><i data-feather="cast"></i></span><span class="title ms-2">Pending</span><span class="badge badge-danger">{{ $pending }}</span></a></li>
                    ...
                    <div class="todo-list-container">
                      ...
                      <div class="todo-list-body">
                        <div class="todo-list-footer">
                            <form action="{{ route('influencer.add.task') }}" method="POST" enctype="multipart/form-data">
                                @csrf 
                            ...
                            <div class="task-container">
                              ...
                              <div class="d-flex align-items-center gap-4">
                                ...
                                <span class="task-action-btn">
                                    @if($list->status == 0)
                                    <form id="update-task-form{{ $list->id }}" action="{{ route('influencer.update.task') }}" method="POST" style="display: inline;">
                                        @csrf
                                    ...
                                    <form id="delete-task-form{{ $list->id }}" action="{{ route('influencer.delete.task') }}" method="POST" style="display: inline;">
                                        @csrf
                                        <input type="hidden" name="id" value="{{ $list->id }}">
