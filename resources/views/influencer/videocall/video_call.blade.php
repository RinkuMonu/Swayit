            ...
            {{-- <div class="video-call-section"> --}}
                <div class="row">
                    <div class="col-md-6 video-call-section">
                        <img src="{{ asset('assets/images/influencer66.png') }}" alt="">
                    </div>
                    <div class="col-md-6 video-call-section">
                        <h4>Video calls for everyone.</h4>
                        ...
                        <form action="{{ route('influencer.generate.videocall.token') }}" method="post">
                            @csrf
                            <button type="submit" class="btn btn-primary" style="font-size: 22px;">Start a video call</button>
                        </form>
                    </div>
                </div>
            {{-- </div> --}}
